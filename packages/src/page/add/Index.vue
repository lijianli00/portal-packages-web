<template>
  <div class="draggable">
    <!-- 预览 -->
    <layoutView v-if="isView" :layout="layout" :gard-components="gardComponents" @back="isView = false"></layoutView>
    <!-- 头部 -->
    <div class="header">
      ...
      <div class="left">
        <el-scrollbar class="scrollbar">
          <div class="left-container">
            <ul v-for="(items, index) in gardList" :key="index">
              <li class="left-title">{{ items.name }}</li>
              <li
        ...
        <div id="content" class="center-container">
          ...
          >
            <grid-item v-for="item in layout" :key="item.i" :x="item.x" :y="item.y" :w="item.w" :h="item.h" :i="item.i">
              <component
                :is="gardComponents[item.type] || item.type"
